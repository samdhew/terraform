...
#================ KMS Configurations ===================
variable "keyspaces_kms_multiregion" {
  description = "If true, KMS will be Multi Region rather than Regional."
  type        = bool
  default     = false

  validation {
    condition     = contains([true, false], var.keyspaces_kms_multiregion)
...
#================ SNS Configurations ===================
variable "keyspaces_sns_subscriptionprotocol" {
  description = "The SNS topic subscription's Protocol. Valid values are email or email-json."
  type        = string
  default     = "email"

  validation {
    condition     = contains(["email", "email-json"], var.keyspaces_sns_subscriptionprotocol)
    error_message = "Must either be email or email-json."
  }
}

variable "keyspaces_sns_subscriptionendpoints" {
...
variable "keyspaces_keyspace_name" {
  description = "The Keyspaces's Keyspace name. The first character must be a letter. Example: gradebook"
  type        = string

  validation {
    condition     = can(regex("^[a-z][0-9a-z_]+$", var.keyspaces_keyspace_name))
    error_message = "Keyspace name must start with a letter. Value only a-z and 0-9 are allowed."
  }

  validation {
    condition     = length(var.keyspaces_keyspace_name) > 3
...
variable "keyspaces_tabledefinition_file" {
  description = "Table definition file name of the Keyspaces's tables. The table definition file must be in the TFCustomResourceConfigs folder. Example: keyspaces_table_definition.json"
  type        = string
  default     = null

  # validation {
  #   condition     = substr(var.keyspaces_tabledefinition_file, 0, 24) == "TFCustomResourceConfigs/"
  #   error_message = "File path must begin with TFCustomResourceConfigs/."
  # }
}

# variable "keyspaces_table_name" {
#   description = "The Keyspaces's table name. The first character must be a letter. Example: itembyprovider"
#   type        = string

#   validation {
#     condition     = can(regex("^[a-z][0-9a-z_]+$", var.keyspaces_table_name))
#     error_message = "Table name must start with a letter. Value only a-z and 0-9 are allowed."
#   }

#   validation {
#     condition     = length(var.keyspaces_table_name) > 3
#     error_message = "Table name length must be greater than 3."
#   }
# }

# variable "keyspaces_table_description" {
#   description = "The Keyspaces's table description."
#   type        = string
#   default     = null
# }

# variable "keyspaces_table_throughputmode" {
#   description = "The Keyspaces's table throughput mode. Valid values are PAY_PER_REQUEST or PROVISIONED."
#   type        = string
#   default     = "PAY_PER_REQUEST"

#   validation {
#     condition     = contains(["PAY_PER_REQUEST", "PROVISIONED"], var.keyspaces_table_throughputmode)
#     error_message = "Must either be PAY_PER_REQUEST or PROVISIONED."
#   }
# }

# variable "keyspaces_table_readcapacity" {
#   description = "The Keyspaces's table read capacity units."
#   type        = number
#   default     = 0
# }

# variable "keyspaces_table_writecapacity" {
#   description = "The Keyspaces's table write capacity units."
#   type        = number
#   default     = 0
# }

# variable "keyspaces_table_pointintimerecovery" {
#   description = "The Keyspaces's table point in time recovery status. Valid values are ENABLED or DISABLED."
#   type        = string
#   default     = "DISABLED"

#   validation {
#     condition     = contains(["ENABLED", "DISABLED"], var.keyspaces_table_pointintimerecovery)
#     error_message = "Must either be ENABLED or DISABLED."
#   }
# }

# variable "keyspaces_table_clientsidetimestamps" {
#   description = "The Keyspaces's table client side timestamps status. Valid values are ENABLED or DISABLED."
#   type        = string
#   default     = "DISABLED"

#   validation {
#     condition     = contains(["ENABLED", "DISABLED"], var.keyspaces_table_clientsidetimestamps)
#     error_message = "Must either be ENABLED or DISABLED."
#   }
# }

# variable "keyspaces_table_ttldefault" {
#   description = "The Keyspaces's table default ttl value. This is in seconds."
#   type        = number
#   default     = 0

#   validation {
#     condition     = var.keyspaces_table_ttldefault >= 0 && var.keyspaces_table_ttldefault <= 630720000
...
variable "keyspaces_route53_hostedzoneid" {
